...
public class CreateCreateEmployeeCommandCommandValidator : AbstractValidator<CreateEmployeeCommand>
{
    public CreateCreateEmployeeCommandCommandValidator()
    {
        ...
        When(x => x.EmployeeDto.StatusId == EmployeeStatus.Active, () =>
        {
            RuleFor(x => x.EmployeeDto.CreatedOn)
